...
namespace Andromeda.Api.Migrations
{
    ...
    [Migration("20260915150904_AddPriceAndUpdateCharge")]
    partial class AddPriceAndUpdateCharge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Andromeda.Api.Models.Price", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Andromeda.Api.Models.Charge", b =>
                {
                    b.HasOne("Andromeda.Api.Models.Price", "Price")
                        .WithMany()
                        .HasForeignKey("PriceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Andromeda.Api.Models.StudentCrew", "StudentCrew")
                        .WithMany()
                        .HasForeignKey("StudentCrewId")
